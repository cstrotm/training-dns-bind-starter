...
#+MACRO: bind916 @@html:<img src="img/bind-9-16-badge.png">@@
#+MACRO: line @@html:<hr />@@
...
* New terminology used in DNS & BIND                               :noexport:
  ...
  * DNS terminology can be confusing and is sometimes overloaded. RFC
    9499 /DNS terminology/ ( https://www.rfc-editor.org/rfc/rfc9499.html )
 ...
 * [[https://datatracker.ietf.org/doc/html/rfc8375][RFC 8375 - Special-Use Domain 'home.arpa.']] defines the special
   ...
   Directory domains.
 * [[https://datatracker.ietf.org/doc/html/rfc7050][RFC 7050 - Discovery of the IPv6 Prefix Used for IPv6 Address
   Synthesis]] and [[https://datatracker.ietf.org/doc/html/rfc8880][RFC 8880 - Special Use Domain Name 'ipv4only.arpa']]
 ...
 * maximum UDP answer packet size in byte as negotiated between =dig=
   ...
   2020/]]
 * {{{bind916}}} [[https://datatracker.ietf.org/doc/html/rfc8914][RFC 8914 - Extended DNS Errors]] defines a way to
...
{{{exercise-end}}}
** TODO explain query log format                                   :noexport:
 ...
 * Men & Mice has compiled 15 essential monitoring test scripts
   ...
   - the scripts are available in the Men & Mice Services Github repos
      https://github.com/menandmice-services/dns-monitoring-scripts
